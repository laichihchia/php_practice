                ...
                <div class="card-body">
                    ...
                    <form name="form1" onsubmit="sendData();return false;" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="mobile" name="mobile" pattern="09\d{2}-?\d{3}-?\d{3}" value="<?=$row['mobile']?>">
                            <div class="form-text red"></div>
                        </div>
                        <div class="mb-3">
...
<script>
    ...
    async function sendData() {
        ...
        if(result.success){
            addMassage.innerHTML = `<i class="fa-regular fa-thumbs-up"></i>修改成功,兩秒後跳回列表`
            setTimeout(() => {
                location.href = 'ab-list.php';
            }, 2000);
        }else{
            addMassage.innerHTML = `<i class="fa-regular fa-thumbs-up"></i>修改失敗,兩秒後跳回列表`
            setTimeout(() => {
                location.href = 'ab-list.php';
            }, 2000);
        }
